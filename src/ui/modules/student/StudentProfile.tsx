    ...
    <div className="min-h-screen bg-background pb-20 flex flex-col items-center">
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-card border-b border-border p-4 sm:p-6">
          <div>
            <h1 className="text-2xl sm:text-3xl mb-1 truncate">Meu Perfil</h1>
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          ...
          {/* Card: Ações */}
          <Card className="bg-card p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold mb-4">Conta</h3>
            <Button
              variant="outline"
      ...
      {/* Bottom Navigation - mesmo padrão, Perfil ativo */}
