        ...
        <div className="glass-card border-0 border-b border-white/10 rounded-none rounded-b-2xl p-4 sm:p-6 lg:px-8">
          <div className="max-w-7xl mx-auto flex items-start justify-between gap-4">
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl font-semibold mb-0.5 text-white tracking-tight">Usuários</h1>
              <p className="text-white/50 text-sm">Gerencie alunos, profissionais e administradores</p>
            </div>
            <Button
              variant="ghost"
              size="sm"
